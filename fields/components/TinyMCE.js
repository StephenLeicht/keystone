...
module.exports = React.createClass({
	...
	getOptions: function() {
		...
		if (this.props.shouldRenderField) {
	...
	render: function() {
		...
		return (
			<div className={className}>
				<textarea ref='editor' style={style} onChange={this.valueChanged} id={this.state.id} className={this.getFieldClassName()} name={this.props.path} readOnly={this.props.readOnly} value={this.props.value}></textarea>
			</div>
		);
	}
